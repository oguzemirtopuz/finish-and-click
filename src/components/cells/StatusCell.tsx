...
export function StatusCell({ value, onChange }: Props) {
  ...
  const trigger = (
    <div
      className="flex items-center justify-center text-[13px] w-full h-full text-white font-medium select-none cursor-pointer hover:brightness-110 transition-all border-l border-white/20"
