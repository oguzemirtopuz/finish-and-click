...
export function PriorityCell({ value, onChange }: Props) {
  ...
  const trigger = (
    <div
      className="flex items-center justify-center text-[13px] font-medium w-full h-full text-white cursor-pointer hover:brightness-110 transition-all border-l border-white/20"
